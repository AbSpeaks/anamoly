...
if(isset($_POST['docsub']))
{
  ...
  $dphone=$_POST['dphone'];
  $query="insert into doctb(username,password,email,spec,docFees,phone)values('$doctor','$dpassword','$demail','$spec','$docFees','$dphone')";
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-8"><input type="text" class="form-control"  name="dphone" required></div><br><br>
                </div>
